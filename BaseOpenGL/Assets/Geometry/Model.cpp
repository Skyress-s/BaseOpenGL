...
KTTexture2D KTTextureFromFile(const string& directory, bool gamma) {
    unsigned int textureID;
    glGenTextures(1, &textureID);
    ...
    if (data) {
        ...
        unsigned char* pixel_data = new unsigned char[num_pixels * pixel_size];
        memcpy(pixel_data, data, num_pixels * pixel_size);
